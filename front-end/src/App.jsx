...
import ContinueToApplication from "./SDC_Files/ContinueToApplication";
import DepartmentSave from "./SDC_Files/Department/DepartmentSave";

const App = () => {
  return (
    <>
      <Routes>
        <Route path="/sdc/login" element={<Login/>}/>
        <Route path="/sdc/continue" element={<ContinueToApplication />} />
        ...
        <Route path="/sdc/department/save" element={<DepartmentSave />} />
